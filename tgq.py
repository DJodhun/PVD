...
from datasets.quijote_data import Quijote15kPointClouds
...
def get_dataset(data, npoints):
    tr_dataset = Quijote15kPointClouds(data=data,
        split='train',
    ...
    te_dataset = Quijote15kPointClouds(data=data,
        split='val',
        tr_sample_size=npoints,
        te_sample_size=npoints,
        scale=1.,
    ...
    for epoch in range(start_epoch, opt.niter):
        ...
        if (epoch + 1) % opt.vizIter == 0 and should_diag:
            ...
            with torch.no_grad():
                ...
                torch.save(x_gen_eval, '%s/epoch_%03d_samples_eval_tens%d.pt' % (output_dir, epoch))
